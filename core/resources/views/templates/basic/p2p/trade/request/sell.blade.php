                            ...
                            <div>
                                ...
                                @if ($ad->user->kv)
                                    <span class="verified-profile">
                                        <img src="{{ asset('assets/images/extra_images/kyc.png') }}" class="verfied-image" data-bs-toggle="tooltip"
                                            title="@lang('KYC Verified')">
                                    </span>
                                @endif
                            </div>
                            <div>
                    ...
                    <div class="order-details__info">
                        <div class="order-details__info-item">
                            ...
                            <h6 class="amount-count mb-0">
                                {{ showAmount($ad->price, currencyFormat: false) }} {{ __(@$ad->fiat->symbol) }}
                            </h6>
                        </div>
                        <div class="order-details__info-item">
                            <span class="title">
                        ...
                        <div class="order-details__info-item">
                            ...
                            <h6 class="amount-count mb-0">
                                {{ showAmount($coinWalletBalance, currencyFormat: false) }} {{ __(@$ad->asset->symbol) }}
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <form class="p2p-order-info-left trade-rquest-form">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" step="any" class="form-control form--control asset-amount" name="asset_amount">
                        <span class="input-group-text">{{ __(@$ad->asset->symbol) }}</span>
                    </div>
                    <span class="mt-1  text--warning fs-11">
                        @lang('Available'): {{ showAmount($sellerWallet->balance, currencyFormat: false) }} {{ __(@$ad->asset->symbol) }}
                    </span>
                </div>
                <div class="form-group">
                    <label class="form--label">@lang('I will receive')</label>
                    <div class="input-group">
                        <input type="number" step="any" class="form-control form--control fiat-amount" name="fiat_amount">
