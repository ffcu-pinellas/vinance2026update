    ...
    @forelse($trades as $trade)
        <tr>
            ...
            <td>
                ...
                @elseif($trade->win_status == Status::BINARY_TRADE_REFUND)
                    <span class="text--info">{{ showAmount($trade->win_amount, currencyFormat: false) }} {{ __(@$trade->coinPair->coin->symbol) }}</span>
                @else
