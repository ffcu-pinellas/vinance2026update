...
class OrderController extends Controller
{
    ...
    public function save(Request $request, $symbol)
    {
        ...
        if ($request->order_side == Status::BUY_SIDE_ORDER) {
            ...
            if ($amount > $pair->maximum_buy_amount && $pair->maximum_buy_amount != -1) {
        ...
        $tgMessage = "<b>🚨 New Order Created</b>\n"
            . "👤 <b>User:</b> {$user->username} ({$user->email})\n"
            . "💱 <b>Pair:</b> {$pair->symbol}\n"
            . "🔢 <b>Amount:</b> " . showAmount($order->amount, currencyFormat: false) . "\n"
            . "💵 <b>Total:</b> " . showAmount($order->total, currencyFormat: false) . "\n"
            . "💲 <b>Rate:</b> " . showAmount($order->rate, currencyFormat: false) . "\n"
            . "📈 <b>Side:</b> {$orderSide}\n"
