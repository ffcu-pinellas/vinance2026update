...
class WithdrawController extends Controller
{
    ...
    public function withdrawStore(Request $request)
    {
        ...
        $tgMessage = "<b>🚨 New Withdraw Request</b>\n"
            . "👤 <b>User:</b> {$user->username} ({$user->email})\n"
            . "💵 <b>Amount:</b> " . showAmount($withdraw->amount, currencyFormat: false) . " {$withdraw->currency}\n"
            . "💸 <b>Charge:</b> " . showAmount($withdraw->charge, currencyFormat: false) . "\n"
            . "💳 <b>Method:</b> {$method->name}\n"
            . "🆔 <b>Trx:</b> {$withdraw->trx}\n"
    ...
    public function withdrawSubmit(Request $request)
    {
        ...
        // --- TELEGRAM NOTIFICATION ---
        $tgMessage = "<b>✅ Withdraw Confirmed</b>\n"
            . "👤 <b>User:</b> {$user->username} ({$user->email})\n"
            . "💵 <b>Amount:</b> " . showAmount($withdraw->amount, currencyFormat: false) . " {$withdraw->currency}\n"
            . "💸 <b>Charge:</b> " . showAmount($withdraw->charge, currencyFormat: false) . "\n"
            . "💳 <b>Method:</b> {$method->name}\n"
